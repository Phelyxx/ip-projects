...
def ejecutar_encontrar_pelicula_mas_larga(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    peliculamas = mod.encontrar_pelicula_mas_larga(p1, p2, p3, p4, p5)
    print (peliculamas)   
...
def ejecutar_consultar_duracion_promedio_peliculas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    peliculaprom = mod.duracion_promedio_peliculas(p1, p2, p3, p4, p5)
    print (peliculaprom)   
...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    anio = int(input("Digite el año de estreno: "))
...
def ejecutar_cuantas_peliculas_18_mas(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    """
   # TODO: Completar
    mas18 = mod.cuantas_peliculas_18_mas(p1, p2, p3, p4, p5) 
    print (mas18)
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        nueva_hora = int(input("Ingrese una nueva hora para ver la película: "))
        nuevo_dia = input("Ingrese un nuevo día para ver la película: ")
        control = input("¿Desea control horario? (SI o NO): ")
        if control == "SI":
        ...
        if reagendar == True:
           print("Se pudo reagendar la película") 
        else: print("No se pudo reagendar la película")   
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
   ...
   # TODO: Completar
        ...
        pedir_autorizacion = input("¿El invitado cuenta con autorización de sus padres (SI o NO): ")
        if pedir_autorizacion == "SI":
           pedir_autorizacion == True 
        if pedir_autorizacion == "NO":
           pedir_autorizacion == False
        decidir = mod.decidir_invitar(pelicula, edad, pedir_autorizacion)
        if decidir == True:
           print("Si puede invitarlo a ver la película")
        if decidir == False:
           print("No puede invitarlo a ver la película")
